...
public class medreseler extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_medreseler);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbarmedrese);
        ...
        mTitle.setText("mEDRESELER");
        TextView editText=findViewById(R.id.editText);
        int[] sliderImageId = new int[]{
                R.drawable.kasimiye, R.drawable.altunboga, R.drawable.hatuniye,R.drawable.melikmansur, R.drawable.muzaffariye,
        };
        ViewPager mViewPager = (ViewPager) findViewById(R.id.viewPage);
        ImageAdapter adapterView = new ImageAdapter(this,sliderImageId);
        mViewPager.setAdapter(adapterView);

        editText.setText("Altun Boğa Medresesi\n" +
                "        \n" +
